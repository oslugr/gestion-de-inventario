		...
		$('#body-tabla-caracteristicas').append(`
			<tr class="text-gray-700 dark:text-gray-400">
				<td class="px-2 py-3 text-sm">
					<input class="w-32" type="text" value="${componentes.data[posicion].caracteristicas[i].nombre}"/>
				</td>
				<td class="px-2 py-3 text-sm">
					<input class="w-32" type="text" value="${componentes.data[posicion].caracteristicas[i].valor}"/>
				</td>
				<td class="px-2 py-3">
