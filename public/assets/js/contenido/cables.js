...
function fila(id, tipo, version) {
	if (version == null) version = "";

	return `
		<tr class="cable text-gray-700 dark:text-gray-400">
			<td class="px-4 py-3">
...
function crearCables() {
	...
	for (i = 0; i < elementos.length; i++)
		filas += fila(elementos[i].id, elementos[i].tipo, elementos[i].version_tipo);
	...
	$("#main-tabla").append(`
		<div class="grid px-4 py-3 text-xs font-semibold tracking-wide text-gray-500 uppercase border-t dark:border-gray-700 bg-gray-50 sm:grid-cols-9 dark:text-gray-400 dark:bg-gray-800">
			<span id="cantidad-pie" class="flex items-center col-span-3">
				Mostrando ${numElementosActuales} de ${cables.cantidad}
			</span>
