...
function fila(id, fecha, localizacion, posicion) {
	...
	return `
		<tr id="recogida-${id}" class="recogida text-gray-700 dark:text-gray-400">
			<td class="px-4 py-3">
				<div class="cursor-pointer flex items-center text-sm" onclick="window.location.href='entrega?id=${id}'">
			...
			<td id="fecha-${id}" class="cursor-pointer px-4 py-3 text-xs" onclick="window.location.href='entrega?id=${id}'">
                ${fecha.split('T')[0]}
			</td>
			<td id="localizacion-${id}" class="cursor-pointer px-4 py-3 text-xs" onclick="window.location.href='entrega?id=${id}'">
				${localizacion}
			</td>
			<td class="px-4 py-3">
